...
var strings = {
    ...
    "edit.ok": "ОК",
    "edit.hoursTitle": "ВСЕГО ЧАСОВ ЧТЕНИЯ",
    "edit.booksTitle": "ВСЕГО КНИГ ПРОЧИТАНО",
    ...
    "about.checking": "Ищу на GitHub новый релиз\u2026",
    "about.uptodate": "Установлена последняя версия.",
    "about.available": "Доступна версия {version}.",
    "about.downloading": "Загружаю обновление\u2026",
    "about.ready": "Обновление загружено. {app} закроется и запустится автоматически. Если этого не произошло, откройте его из меню приложений.",
